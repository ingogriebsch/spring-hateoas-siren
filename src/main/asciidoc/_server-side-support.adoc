...
Therefore this librarys provides a builder API that allows to build a siren model which is then transfered into the respective Siren {siren-entity-url}[entity] structure.
