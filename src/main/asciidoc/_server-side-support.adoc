...
Even if it is in most cases probably sufficient to simply use the available {spring-hateoas-representatio-model-url}[representation models] it can be necessary in some cases to be able to build such quite complex structures.
